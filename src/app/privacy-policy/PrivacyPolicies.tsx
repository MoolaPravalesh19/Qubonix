...
export function PrivacyPolicies() {
    return (
        <div className="max-w-6xl mx-auto px-4 py-12 text-gray-800 leading-relaxed font-sans">
            {/* Header Section */}
            <h1 className="text-4xl font-bold mb-2 text-gray-900">Privacy Policy</h1>
            <p className="text-sm text-gray-500 mb-8 border-b pb-4">Last updated on March 19th, 2024</p>

            {/* 1. Introduction Section */}
            <section className="mb-10">
                <h2 className="text-2xl font-bold mb-4 text-gray-900">Introduction to Privacy Policy</h2>
            ...
            <section className="mb-10">
                <h2 className="text-2xl font-bold mb-4 text-gray-900">Information we collect and how we use it</h2>
                <div className="space-y-4 text-sm md:text-base text-gray-700 text-justify">
                    <p>
                    ...
                    <p>
                        If we use or plan to use your information in a manner different than the purpose for which it is collected, then we will ask you for your consent prior to such use. The Personal Information collected will be used only for the purpose of enabling you to use the services provided by us, to help promote a safe service, calibrate consumer interest in our products and services, inform you about online offers and updates, troubleshoot problems, customize User experience, detect and protect us against error, fraud and other criminal activity, collect money, enforce our terms and conditions, and as otherwise described to you at the time of collection of such information.
                    </p>
                </div>
            </section>
            ...
            <section className="mb-10">
                <h2 className="text-2xl font-bold mb-4 text-gray-900">Account information of Merchants</h2>
                <div className="space-y-4 text-sm md:text-base text-gray-700 text-justify">
                    <p>
            ...
            <section className="mb-10">
                <h2 className="text-2xl font-bold mb-4 text-gray-900">Customer Information</h2>
            ...
            <section className="mb-10">
                ...
                <div className="space-y-4 text-sm md:text-base text-gray-700 text-justify">
                    <p>
                        We record information relating to your use of Razorpay, such as the searches you undertake, the pages you view, your browser type, IP address, location, requested URL, referring URL, and timestamp information. We use this type of information to administer Razorpay and provide the highest possible level of security and service to you. We also use this information in the aggregate to perform statistical analyses of User behavior and characteristics in order to measure interest in and use of the various areas of Razorpay. However, you cannot be identified from this aggregate information.
                    </p>
                    <p>
            ...
            <section className="mb-10">
                ...
                <div className="space-y-4 text-sm md:text-base text-gray-700 text-justify">
                    ...
                    <p>
                        If you choose to disable cookies, some areas of Razorpay may not work properly or at all. Razorpay uses third party tools, who may collect anonymous information about your visits to Razorpay using cookies, and interaction with Razorpay products and services. Such third parties may also use information about your visits to Razorpay products and services and other web sites to target advertisements for Razorpay's products and services. No Personal Information is collected or used in this process.
                    </p>
                    <p>
                        These third parties do not know or have access to the name, phone number, address, email address, or any Personal Information about Razorpay's Users. Razorpay Users can opt-out of sharing this information with third parties by deactivating cookies, the process of which varies from browser to browser. Please refer to the help file of your browser to understand the process of deactivating cookies on your browser.
                    </p>
                </div>
            </section>

            {/* 7. Enforcement & Transfer */}
            <section className="mb-10">
                <h2 className="text-2xl font-bold mb-4 text-gray-900">Enforcement and Transfer of Information</h2>
                <div className="space-y-4 text-sm md:text-base text-gray-700 text-justify">
                    <p>
            ...
            {/* 8. Links and Access */}
            <section className="mb-10">
                <h2 className="text-2xl font-bold mb-4 text-gray-900">Links and User Access</h2>
                <div className="space-y-4 text-sm md:text-base text-gray-700 text-justify">
                    <p>
            ...
            <section className="mb-10">
                ...
                <div className="space-y-4 text-sm md:text-base text-gray-700 text-justify">
                    ...
                    <p className="bg-yellow-50 p-4 border-l-4 border-yellow-400 italic">
                        If you have any questions about the security on Razorpay, please contact us at disclosures@razorpay.com. You hereby acknowledge that Razorpay is not responsible for any intercepted information sent via the internet, and you hereby release us from any and all claims arising out of or related to the use of intercepted information in any unauthorized manner.
                    </p>
                </div>
            </section>

            {/* 10. Modifications & Law */}
            <section className="mb-10">
            ...
            <section className="mt-12 pt-8 border-t border-gray-200">
                ...
                <div className="border border-gray-200 rounded-lg p-8 shadow-sm bg-white">
                    <h3 className="text-xl font-bold mb-6">DPO Contact Details</h3>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-y-4 gap-x-12 text-sm leading-relaxed">
                        ...
                        <div className="space-y-2">
                            ...
                            <p><strong>E-mail:</strong> <span className="text-blue-600 underline">dpo@razorpay.com</span></p>
                            <div className="flex flex-col">
                                <span className="font-bold">Grievances portal:</span>
                                <a href="https://razorpay.com/grievances/" target="_blank" rel="noreferrer" className="text-blue-600 underline">
