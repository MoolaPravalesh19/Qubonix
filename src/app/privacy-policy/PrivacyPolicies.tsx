...
export function PrivacyPolicies() {
    return (
        <div className="max-w-4xl mx-auto px-4 py-12 text-gray-800 leading-relaxed text-justify">
            {/* Header Section */}
            <h1 className="text-3xl md:text-5xl font-bold mb-4 text-blue-600 border-b pb-4">
                Privacy Policy
            </h1>
            ...
            <section className="mb-10">
                ...
                <div className="space-y-4 text-sm md:text-base">
                    ...
                    <p>
                        The terms "we", "our" and "us" refer to Razorpay and the terms "you", "your" and "User" refer to you, as a user of Razorpay.
                    </p>
                    <p>
                        The term "Personal Information" means information that you provide to us which personally identifies you to be contacted or identified, such as your name, phone number, email address, and any other data that is tied to such information.
                    </p>
                    <p>
                        Our practices and procedures in relation to the collection and use of Personal Information have been set-out below in order to ensure safe usage of the Website for you. We have implemented reasonable security practices and procedures that are commensurate with the information assets being protected and with the nature of our business.
                    </p>
                    <p>
                        While we try our best to provide security that is better than the industry standards, because of the inherent vulnerabilities of the internet, we cannot ensure or warrant complete security of all information that is being transmitted to us by you. By visiting this Website, you agree and acknowledge to be bound by this Privacy Policy and you hereby consent that we will collect, use, process and share your Personal Information in the manner set out herein below.
                    </p>
                    <p>
                        If you do not agree with these terms, do not use the Website. It is clarified that the terms and conditions that are provided separately, form an integral part of your use of this Website and should be read in conjunction with this Privacy Policy.
                    </p>
                </div>
            </section>
            ...
            <section className="mb-10">
                ...
                <div className="space-y-4 text-sm md:text-base">
                    ...
                    <p>
                        You may opt to not provide us with certain information, however that will restrict you from registering with us or availing some of our features and services. We use commercially reasonable efforts to ensure that the collection of Personal Information is limited to that which is necessary to fulfill the purposes identified below.
                    </p>
                    <p>
                        If we use or plan to use your information in a manner different than the purpose for which it is collected, then we will ask you for your consent prior to such use.
                    </p>
                    <p>
            ...
            {/* 3. Account Information of Merchants */}
            <section className="mb-10">
                <h2 className="text-2xl font-semibold mb-4 text-gray-900">
            ...
            <section className="mb-10">
                ...
                <div className="space-y-4 text-sm md:text-base">
                    <p>
                        We also store customer information of customers such as address, mobile number, Third Party Wallet details, Card Details and email address making payments through Razorpay checkouts.
                    </p>
                    <p>
            ...
            <section className="mb-10">
                ...
                <div className="space-y-4 text-sm md:text-base">
                    ...
                    <p>
                        We also use this information in the aggregate to perform statistical analyses of User behavior and characteristics in order to measure interest in and use of the various areas of Razorpay. However, you cannot be identified from this aggregate information.
                    </p>
                    <p>
            ...
            <section className="mb-10">
                ...
                <div className="space-y-4 text-sm md:text-base">
                    ...
                    <p>
                        If you choose to disable cookies, some areas of Razorpay may not work properly or at all. Razorpay uses third party tools, who may collect anonymous information about your visits to Razorpay using cookies, and interaction with Razorpay products and services.
                    </p>
                    <p>
                        Such third parties may also use information about your visits to Razorpay products and services and other web sites to target advertisements for Razorpay's products and services. No Personal Information is collected or used in this process. These third parties do not know or have access to the name, phone number, address, email address, or any Personal Information about Razorpay's Users.
                    </p>
                    <p>
                        Razorpay Users can opt-out of sharing this information with third parties by deactivating cookies, the process of which varies from browser to browser. Please refer to the help file of your browser to understand the process of deactivating cookies on your browser.
                    </p>
                </div>
            </section>
            ...
            <section className="mb-10">
                ...
                <div className="space-y-4 text-sm md:text-base">
                    ...
                    <p>
                        These third parties are required not to use your Personal Information other than to provide the services requested by you. We may share your Personal Information with our parent company, subsidiaries, joint ventures, or other companies under a common control (collectively, the "Affiliates") that we may have now or in the future, in which case we will require them to honor this Privacy Policy.
                    </p>
                    <p>
                        If another company acquires our company or our assets, that company will possess your Personal Information, and will assume the rights and obligations with respect to that information as described in this Privacy Policy.
                    </p>
                    <p>
            ...
            <section className="mb-10">
                ...
                <div className="space-y-4 text-sm md:text-base">
                    ...
                    <p>
                        Except as set forth herein, we do not share your Personal Information with those third parties, and are not responsible for their privacy practices. We suggest you read the privacy policies on all such third party websites.
                    </p>
                </div>
            </section>
            ...
            <section className="mb-10">
                ...
                <p className="text-sm md:text-base">
                    As a registered Razorpay User, you can modify some of your Personal Information and your privacy preferences by accessing the "Account" section of this Website.
                </p>
            </section>
            ...
            <section className="mb-10">
                ...
                <div className="space-y-4 text-sm md:text-base">
                    <p>
                        Your account is password protected. We use industry standard measures to protect the Personal Information that is stored in our database. We follow industry standard best practices on Information Security, as also mentioned in our website.
                    </p>
                    <p>
                        We limit the access to your Personal Information to those employees and contractors who need access to perform their job function, such as our customer service personnel.
                    </p>
                    <p>
                        If you have any questions about the security on Razorpay, please contact us at disclosures@razorpay.com.
                    </p>
                    <p className="bg-yellow-50 p-4 border-l-4 border-yellow-400 italic">
                        You hereby acknowledge that Razorpay is not responsible for any intercepted information sent via the internet, and you hereby release us from any and all claims arising out of or related to the use of intercepted information in any unauthorized manner.
                    </p>
                </div>
            </section>
            ...
            <section className="mb-10">
                ...
                <div className="space-y-4 text-sm md:text-base">
                    <p>
                        Our Privacy Policy is subject to change at any time without notice. To make sure you are aware of any changes, please review this policy periodically. These changes will be effective immediately on the Users of Razorpay.
                    </p>
                    <p>
                        Please note that at all times you are responsible for updating your Personal Information, including to provide us with your most current e-mail address. If you do not wish to permit changes in our use of your Personal Information, you must notify us promptly that you wish to deactivate your account with us.
                    </p>
                    <p>
                        Continued use of Razorpay after any change/ amendment to this Privacy Policy shall indicate your acknowledgement of such changes and agreement to be bound by the terms and conditions of such changes.
                    </p>
                </div>
            </section>
            ...
            <section className="mt-12 pt-8 border-t-2 border-gray-200">
                ...
                <div className="bg-gray-50 p-6 rounded-lg border border-gray-200">
                    <h3 className="text-lg font-bold mb-4">DPO Contact Details</h3>
                    <div className="grid md:grid-cols-2 gap-4 text-sm md:text-base">
                        <div>
                            <p><strong>DPO:</strong> Mr. SHASHANK KARINCHETI</p>
                            <p><strong>Company:</strong> Razorpay Software Private Limited</p>
                            <p><strong>Address:</strong> No. 22, 1st Floor, SJR Cyber, Laskar - Hosur Road, Adugodi, Bangalore - 560030</p>
                        </div>
                        <div>
                            <p><strong>Ph:</strong> 080-46669555</p>
                            <p><strong>E-mail:</strong> <a href="mailto:dpo@razorpay.com" className="text-blue-600">dpo@razorpay.com</a></p>
                            <p><strong>Grievances portal:</strong> <a href="https://razorpay.com/grievances/" target="_blank" rel="noopener noreferrer" className="text-blue-600">https://razorpay.com/grievances/</a></p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <footer className="mt-16 pt-8 border-t border-gray-100">
                <h3 className="text-xl font-bold mb-4 text-gray-900">Acceptance Details</h3>
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-[12px] text-gray-600 bg-gray-50 p-4 rounded">
                    <div>
                        <p className="font-bold">Owner Name</p>
                        <p>BARUN KUMAR SINGH</p>
                    </div>
                    <div>
                        <p className="font-bold">Owner Id</p>
                        <p>SBi5Der TOpn6yK</p>
                    </div>
                    <div>
                    ...
                    <div className="col-span-2">
                        ...
                        <p>info.qubnixtechnologies@gmail.com</p>
                    </div>
                </div>
            </footer>
        </div>
