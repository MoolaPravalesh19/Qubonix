export function PrivacyPolicies() {
    return (
        <div>
            ...
            <p>This privacy policy (the "Privacy Policy") applies to your use of the website of Razorpay hosted
                at
                razorpay.com, the Services (as defined under the Razorpay "Terms of Use") and Razorpay applications on
                ...
                Razorpayand the terms "you", "your" and "User" refer to you, as a
                user of
                Razorpay. The term "Personal Information" means information that you provide to us which
                ...
                this Website and should be read in conjunction with this Privacy Policy</p>
                <h3>Information we collect and how we use it</h3>
                <p>We collect, receive and store your Personal Information. If you provide your third-party account credentials
...
and as otherwise described to you at the time of collection of such information.</p>
<h2>Account information of Merchants</h2>
<p>If you create an account to take advantage of the full range of services offered on Razorpay, we ask for and
...
wish to receive such SMSs from us, please notify us at
razorpay.com/supportto stop receiving SMSs from us.
...
<p>We also store customer information of customers such as address, mobile number, Third Party Wallet details,
...
customer</p>
<h2>Activity</h2>
<p>We record information relating to your use of Razorpay, such as the searches you undertake, the pages you
...
to Our IP, without our express written permission.</p>
<h2>Cookies</h2>
<p>We send cookies to your computer in order to uniquely identify your browser and improve the quality of our
...
your browser.</p>
<h2>Enforcement</h2>
<p>We may use the information we collect in connection with your use of Razorpay (including your Personal
Information) in order to investigate, enforce, and apply our terms and conditions and Privacy Policy.</p>
<h2>Transfer of Information</h2>
<p>We do not share your Personal Information with any third party apart from financial institutions such as
...
<h2>Links</h2>
<p>References on this Website to any names, marks, products or services of third parties or hyperlinks to third
...
<p>As a registered Razorpay User, you can modify some of your Personal Information and your privacy
preferences by accessing the "Account" section of this Website.</p>
<h2>Security</h2>
<p>Your account is password protected. We use industry standard measures to protect the Personal Information
...
have any questions about the security on Razorpay, please contact us at
...
<p>Your use of this Website will be governed by and construed in accordance with the laws of India. The Users
...
the jurisdiction of such courts/ tribunals.</p>
<h2>Complaints and Grievance Redressal</h2>
<p>If you contact us to provide feedback, register a complaint, or ask a question, we will record any Personal
